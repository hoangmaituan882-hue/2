...
export function Hero() {
  const draw = {
    ...
    visible: (custom: { delay: number; dur?: number; color: string }) => ({
      ...
      transition: {
        pathLength: { delay: custom.delay, type: "spring", duration: custom.dur || 0.8, bounce: 0 },
        opacity: { delay: custom.delay, duration: 0.01 },
        stroke: { delay: 0, duration: 4.8, times: [0, 0.83, 1], ease: "easeInOut" } // 4.8s * 0.83 ~ 4.0s
      }
    })
  };
  ...
  const drawDot = {
    ...
    visible: (custom: { delay: number }) => ({
      ...
      transition: { 
        scale: { delay: custom.delay, type: "spring", stiffness: 300, damping: 10 },
        opacity: { delay: custom.delay, duration: 0.01 },
        fill: { delay: 0, duration: 4.8, times: [0, 0.83, 1], ease: "easeInOut" }
      }
    })
  };

  const paths = [
    { d: "M 80 260 Q 140 150 160 80 C 170 30 100 40 100 100 Q 100 190 200 230 C 250 250 200 300 150 290", delay: 0.2, dur: 0.6, color: "#abc378" },
    { d: "M 190 120 C 220 20 240 20 230 80 L 210 250 M 210 170 C 240 120 280 120 280 170 L 270 250 C 270 270 300 250 310 230", delay: 0.6, dur: 0.6, color: "#abc378" },
    { d: "M 310 170 C 310 200 300 250 310 250 C 330 250 340 230 350 220", delay: 1.0, dur: 0.4, color: "#abc378" },
    { d: "M 420 170 L 390 280 C 370 340 330 350 330 310 C 330 270 400 220 440 200", delay: 1.3, dur: 0.6, color: "#abc378" },
    { d: "M 460 170 C 460 200 450 250 460 250 C 480 250 490 230 500 220", delay: 1.8, dur: 0.4, color: "#abc378" },
    { d: "M 550 150 C 500 150 500 220 550 220 C 580 220 580 140 550 140 L 540 240 C 540 260 570 240 580 230", delay: 2.1, dur: 0.5, color: "#abc378" },
    { d: "M 600 160 L 590 250 M 590 180 C 620 140 650 140 650 180 L 640 250 C 640 270 670 250 680 230", delay: 2.4, dur: 0.6, color: "#abc378" }
  ];

  const dots = [
    { cx: 315, cy: 110, delay: 1.3 },
    { cx: 425, cy: 110, delay: 1.8 },
    { cx: 465, cy: 110, delay: 2.1 }
  ];

  const heart = { d: "M 780 150 C 780 110, 730 110, 730 150 C 730 210, 780 250, 780 250 C 780 250, 830 210, 830 150 C 830 110, 780 110, 780 150", delay: 3.0, dur: 0.8, color: "#f9a8d4" };
  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center items-center py-20 px-4 md:px-8 max-w-7xl mx-auto w-full">
          ...
          <motion.div 
            ...
            variants={{
              ...
              visible: {
                ...
                transition: { delay: 4.5, duration: 3.5, repeat: Infinity, ease: "easeInOut" }
              }
            }}
          >
      ...
      >
        <div className="relative h-[650px] w-full overflow-hidden bg-[#f5f5f5] dark:bg-[#1a1a1a] border border-border/40 rounded-xl shadow-[0_8px_40px_rgb(0,0,0,0.08)] flex flex-col">
          {/* Browser Header */}
          ...
          <div className="flex flex-1 p-4 gap-4 overflow-hidden">
            ...
            {/* Column 1: Chat Mock */}
            <div className="flex-[4] flex flex-col bg-white dark:bg-[#222] border border-border/40 rounded-xl overflow-hidden shadow-sm relative">
               <div className="h-12 border-b border-border/40 flex items-center justify-between px-4 shrink-0">
                 ...
                 <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                    <div className="size-1.5 rounded-full bg-[#27c93f]" /> 在线
                 </div>
               </div>
               ...
               <div className="flex-1 p-4 flex flex-col gap-4 overflow-y-auto">
                 ...
                 <div className="flex justify-start relative group">
                   <div className="bg-white dark:bg-[#333] border border-border/60 p-3 px-4 rounded-2xl rounded-tl-sm text-[13px] max-w-[90%] shadow-sm leading-relaxed">
                     你终于来了！我好想你~ 对了，上次你说工作压力好大，最近好点了吗？ ...
                   </div>
                 </div>
                 ...
                 <div className="flex items-center gap-1.5 text-xs text-muted-foreground mt-2 px-1">
                   <span className="animate-spin duration-3000">↻</span> 思考中...
                 </div>
               </div>
            ...
            <div className="flex-[3] flex flex-col gap-4">
              <div className="h-[280px] bg-white dark:bg-[#222] border border-border/40 rounded-xl overflow-hidden shadow-sm flex flex-col">
                <div className="h-10 border-b border-border/40 flex items-center px-4 shrink-0 text-sm font-semibold gap-1.5">
                  <span className="text-[16px]">⚡️</span> 事件
                </div>
            ...
            <div className="flex-[4] bg-white dark:bg-[#222] border border-border/40 rounded-xl overflow-hidden shadow-sm flex flex-col relative">
               <div className="h-10 border-b border-border/40 flex items-center px-4 shrink-0 text-[13px] gap-4">
                 <div className="font-semibold text-[#a4c639] h-full flex items-center border-b-2 border-[#a4c639] cursor-pointer">活动</div>
                 <div className="text-muted-foreground cursor-pointer hover:text-foreground">记忆</div>
               </div>
               ...
               <div className="p-4 flex flex-col gap-3">
                 <div className="border border-border/40 rounded-lg p-3 flex items-start gap-3">
                   ...
                   <div className="flex flex-col gap-1">
                     <div className="text-[13px] font-medium">回忆记忆</div>
                     <div className="text-[12px] text-muted-foreground">「动漫推荐」 (3 条结果)</div>
                   </div>
                 </div>
               </div>
